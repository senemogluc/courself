...
<div class="container">
            ...
            <?php
                ...
                $sql = "SELECT instructors.IName, courses.cName, courses.lvl, courses.Price, courses.numOfStudents, courses.Duration FROM gives, courses, instructors where instructors.ID=gives.InstructorID and courses.ID=gives.CourseID and courses.Category='Design'";
